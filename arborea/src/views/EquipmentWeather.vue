  	...
  	<div :class="$style.equipmentWeather">
    		<div :class="$style.equipmentPlannerWeatherInfo">
      			<div :class="$style.component2">
        				<img :class="$style.image1Icon" src="../assets/images/image 1.svg" alt="" />
        				<div :class="$style.textContentTitle">
          					<div :class="$style.title">-10°C</div>
        				</div>
      			</div>
      			<div :class="$style.component3">
        				<img :class="$style.image1Icon" src="../assets/images/image 2.svg" alt="" />
        				<div :class="$style.textContentTitle2">
          					<div :class="$style.title">70%</div>
        				</div>
      			</div>
      			<div :class="$style.component3">
        				<img :class="$style.image1Icon" src="../assets/images/image 3.svg"alt="" />
    		...
    		<div :class="$style.pageTitle">
      			...
      			<div :class="$style.iconButton">
        				<img :class="$style.arrowRightIcon" alt="" />
      			</div>
    		</div>
    		...
    		<div :class="$style.bottombarWeather">
      			...
      			<div :class="$style.mynauimapSolidParent">
        				...
        				<img :class="$style.mynauiflowerSolidIcon" alt="" @click="onTextContentTitleClick" />
        				<img :class="$style.mynauishoppingBagSolidIcon" alt="" @click="onTextContentTitleClick" />
        				<img :class="$style.mynauimapSolidIcon" alt="" />
        				<img :class="$style.mynauimapSolidIcon" alt="" />
      			</div>
